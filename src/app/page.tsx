      ...
      <section id="contact" className="py-12">
        <div className="rounded-2xl bg-blue-800 border-2 border-white shadow-xl p-6 sm:p-8">
          ...
          <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-6 items-start">
            ...
            <div className="space-y-4 sm:text-right sm:justify-self-end">
              <a href="tel:7147185477" className="flex items-center gap-3 text-white hover:underline underline-offset-4 sm:justify-end max-w-full">
                ...
                <span>(714) 718-5477</span>
              </a>
              <a href="mailto:relentlessrecoveryofoklahoma@gmail.com" className="flex items-start gap-3 text-white hover:underline underline-offset-4 sm:justify-end max-w-full">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-6 w-6 sm:h-7 sm:w-7">
                ...
                <span className="break-all">relentlessrecoveryofoklahoma@gmail.com</span>
              </a>
            </div>
          </div>
        </div>
