        ...
        {isOpen && (
          <div id="primary-menu" className="sm:hidden pb-3">
            <div className="flex flex-col gap-1 pt-2 text-sm">
              <Link href="#hero" onClick={() => setIsOpen(false)} className="px-2 py-2 rounded hover:bg-blue-800">Home</Link>
              <Link href="#vision" onClick={() => setIsOpen(false)} className="px-2 py-2 rounded hover:bg-blue-800">Vision</Link>
              <Link href="#about" onClick={() => setIsOpen(false)} className="px-2 py-2 rounded hover:bg-blue-800">About</Link>
            </div>
          </div>
        )}
      </div>
